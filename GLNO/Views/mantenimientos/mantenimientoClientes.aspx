<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mantenimientoClientes.aspx.cs" Inherits="GLNO.Views.mantenimientos.mantenimientoClientes" %>
...
<body>
    <form id="form1" runat="server">
        <asp:ScriptManager ID="scriptt" runat="server" ></asp:ScriptManager>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="mantenimientoClientes.aspx">Mantenimiento Clientes <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="mantenimientos/mantenimientoClientes.aspx">Mantenimiento Productos</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#">Registro de venta</a>
      </li>
      <li class="nav-item">
          ...
          <div class="row">
            <div class="col-lg-12 ">
                <div class="input-group mb-3">
                     <div class="col-lg-2">
                      <label  id="encabasignados" runat="server" >Nombre</label>
             <asp:TextBox runat="server" TextMode="SingleLine" ID="nombres"  placeholder="Nombre" CssClass="form-control"  />
                          </div>
                        <div class="col-lg-2">
                      <label  id="Label1" runat="server" >Apellido</label>
               <asp:TextBox runat="server" TextMode="SingleLine" ID="apellidos"  placeholder="Apellido" CssClass="form-control"  />
                          </div>
                    <div class="col-lg-2">
                        <label>Dirección</label>
                         <asp:TextBox runat="server"  TextMode="SingleLine" ID="direccion" placeholder="8 av 9-10 zona 21" CssClass="form-control" />

                    </div>
                        <div class="col-lg-2">
                      <label  id="Label3" runat="server" >DPI</label>
             <asp:TextBox runat="server" TextMode="Number" ID="dpi"  placeholder="45" CssClass="form-control"  />
                          </div> 
                      <div class="col-lg-2">
                      <label  id="Label2" runat="server" >Edad</label>
             <asp:TextBox runat="server" TextMode="Number" ID="edad"  placeholder="45" CssClass="form-control"  />
                          </div> 
                    <div class="col-lg-2">
                      <label  id="lblbs" runat="server" ></label>
                    <center>
             <asp:Button ID="btnguardarcliente" Font-Names=" 'Rubik', sans-serif" runat="server" Width="80%" Height="100%" CssClass="btn btn-primary" Text="Guardar" OnClick="btnguardarcliente_Click" />
                   </center>
                          </div>
                         ...
                         <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="NOMBRES">
                          ...
                          <asp:TemplateField ControlStyle-CssClass="diseño" HeaderText="APELLIDOS">
                           ...
                           <asp:Label ID="lblapell"  Width="100%" Text='<%# Eval("apellidos") %>' runat="server" />
                                ...
                                <EditItemTemplate>
                            <asp:TextBox ID="txtapell" Required="ture" TextMode="SingleLine" Text='<%# Eval("apellidos") %>' runat="server" />
                        </EditItemTemplate>
                    </asp:TemplateField>
